...
__all__ = [
    'DISPID_SPCIdToPhone', 'ISpNotifySource', 'DISPID_SPEsCount',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_RESERVED5',
    'SPPARTOFSPEECH', 'SPPS_Function', 'eWORDTYPE_ADDED',
    'SPINTERFERENCE_NOSIGNAL', 'SRADefaultToActive', 'STCAll',
    'DISPID_SpeechMemoryStream', 'SpeechDiscardType',
    'SPEI_START_SR_STREAM', 'ISpObjectToken', 'SPDATAKEYLOCATION',
    'SECFIgnoreKanaType', 'SpeechRegistryLocalMachineRoot',
    'tagSPPROPERTYINFO', 'eLEXTYPE_PRIVATE4',
    'SpeechRegistryUserRoot', 'DISPID_SRGetPropertyString',
    'DISPID_SVSLastBookmarkId', 'DISPID_SDKGetStringValue',
    'DISPID_SPERetainedSizeBytes', 'SSFMOpenReadWrite', 'ISpVoice',
    'DISPID_SVResume', 'SPGRAMMARSTATE', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRGSetTextSelection', 'DISPID_SVVoice', 'SPRECOSTATE',
    'DISPID_SRCEAdaptation', 'SAFT44kHz16BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRAInterpreter',
    ...
    'ISpeechPhoneConverter', 'SP_VISEME_12',
    'DISPID_SRSCurrentStreamNumber', 'SAFTCCITT_ALaw_44kHzMono',
    'SPBO_AHEAD', 'SVESentenceBoundary', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechPhraseElement', 'DISPID_SRProfile',
    'DISPID_SRCBookmark', 'SVSFParseMask', 'SAFT22kHz8BitMono',
    'SPPS_Modifier', 'DISPID_SOTGetStorageFileName', 'SPPS_RESERVED1',
    'SRSActive', 'DISPID_SRGRecoContext', 'SBOPause',
    'SDA_Consume_Leading_Spaces', 'Speech_Default_Weight',
    'SpeechTokenKeyAttributes', 'DISPID_SPRuleChildren',
    'SAFT16kHz16BitMono', 'SDTAll', 'DISPID_SOTCSetId', 'SGSDisabled',
    'DISPID_SRDisplayUI', 'SPAR_Medium', 'SREPrivate',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRId',
    'SGDSActiveWithAutoPause', 'DISPID_SLGetWords',
    'SpeechPropertyResponseSpeed', 'SPVISEMES', 'SECFNoSpecialChars',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRRTStreamTime',
    'DISPID_SLPs_NewEnum', 'SPEI_INTERFERENCE', 'SPEI_PHONEME',
    'DISPID_SRCEFalseRecognition', 'SPPS_Verb', 'SASRun',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPEActualConfidence',
    'ISpNotifySink', 'DISPID_SABIEventBias', 'SAFT11kHz8BitStereo',
    'SWPKnownWordPronounceable', 'SPWORDPRONOUNCEABLE',
    'SPXRO_Alternates_SML', 'SPSEMANTICFORMAT',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLWType', 'SVP_16',
    'ISpDataKey', 'SDTLexicalForm', 'SAFTADPCM_22kHzMono',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRSAddWordTransition',
    'SpCompressedLexicon', 'DISPID_SABIMinNotification', 'SVP_12',
    'DISPID_SOTSetId', 'DISPID_SRRRecoContext', 'SPPHRASE',
    'SVSFUnusedFlags', 'ISpRecoContext', 'DISPID_SRRecognizer',
    'SAFT48kHz8BitMono', 'SAFTADPCM_11kHzStereo',
    'DISPIDSPTSI_ActiveOffset', 'SpeechRunState',
    ...
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPIGetText', 'SPSHT_EMAIL',
    'DISPID_SOTDataKey', 'SAFTADPCM_8kHzMono', 'SP_VISEME_20',
    'DISPID_SVEVoiceChange', 'SPWAVEFORMATTYPE', 'SPAS_RUN',
    'SPEI_RESERVED2', 'DISPID_SpeechPhraseBuilder', 'SpWaveFormatEx',
    'SPSHT_Unknown', 'DISPID_SDKEnumValues', 'SPGS_DISABLED',
    'SDTAudio', 'DISPID_SRSetPropertyNumber', 'SVPOver',
    'DISPID_SOTMatchesAttributes', 'DISPID_SOTsCount', 'ISpShortcut',
    'SPEI_REQUEST_UI', 'DISPID_SPEAudioSizeBytes', 'SPEI_RESERVED3',
    'DISPID_SRGSetWordSequenceData', 'ISpeechGrammarRule',
    'DISPID_SVEStreamStart', 'SpeechPropertyResourceUsage',
    'SPAR_Low', 'IInternetSecurityMgrSite', 'SP_VISEME_14',
    'SPINTERFERENCE_TOOLOUD', 'SPINTERFERENCE_LATENCY_WARNING',
    'SECFIgnoreWidth', 'SPPS_Interjection', 'DISPID_SLWs_NewEnum',
    'SPVPRIORITY', 'SREAudioLevel', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SPILanguageId', 'SGDSActiveUserDelimited',
    'DISPID_SPRulesItem', 'DISPID_SPRsCount',
    'DISPID_SpeechRecognizer', 'DISPID_SPIRetainedSizeBytes',
    'LONG_PTR', 'SPPS_RESERVED4', 'DISPID_SMSADeviceId',
    'SECNormalConfidence', 'DISPID_SAVolume', 'SPEI_HYPOTHESIS',
    'SAFT8kHz16BitStereo', 'SAFT24kHz16BitMono',
    'SAFT32kHz8BitStereo', 'ISpPhraseAlt', 'SpeechAllElements',
    'SREStateChange', 'SpeechAudioFormatType',
    'SPEI_PROPERTY_NUM_CHANGE', 'SREHypothesis', 'DISPID_SRState',
    ...
    'SpeechUserTraining', 'SVEWordBoundary', 'DISPID_SOTCDefault',
    'DISPID_SPCLangId', 'SDKLCurrentConfig',
    'DISPID_SGRsCommitAndSave', 'ISpPhrase',
    'ISpeechRecoResultDispatch', 'SGSEnabled', 'SRTAutopause',
    'DISPID_SVSpeakCompleteEvent', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPVPRI_NORMAL', 'DISPID_SPPId', 'SAFTDefault',
    'SDTPronunciation', 'SPCT_DICTATION', 'DISPID_SPELexicalForm',
    'SDTReplacement', 'SVSFParseSsml', 'ISpeechVoiceStatus',
    'DISPID_SMSAMMHandle', 'DISPID_SVSRunningState',
    'DISPID_SVAudioOutputStream', 'SECFDefault',
    'SAFT22kHz8BitStereo', 'SPEI_SR_BOOKMARK',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGCmdSetRuleIdState', 'SPRST_NUM_STATES', 'SVPAlert',
    'SPLO_STATIC', 'SPSLMA', 'SpeechGrammarState',
    'DISPID_SGRsFindRule', 'SAFT11kHz8BitMono', 'DISPID_SGRName',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFNLPMask',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPIAudioStreamPosition',
    'SINoSignal', 'eLEXTYPE_PRIVATE8', 'DISPID_SGRClear',
    ...
    'SPINTERFERENCE_TOOFAST', 'SpeechVoiceCategoryTTSRate',
    'SpeechFormatType', 'DISPID_SVSInputSentencePosition',
    'DISPID_SPPConfidence', 'ISpeechMMSysAudio', 'SpeechTokenContext',
    'DISPID_SpeechLexiconProns', 'DISPID_SLGetGenerationChange',
    'SpInprocRecognizer', 'STSF_AppData', 'SpMMAudioIn',
    'DISPID_SRCEventInterests', 'SAFT22kHz16BitStereo',
    'SPWF_SRENGINE', 'DISPID_SVIsUISupported',
    'SpeechPropertyComplexResponseSpeed', 'SPINTERFERENCE_NOISE',
    'SDKLCurrentUser', 'SPINTERFERENCE_NONE', 'SDKLDefaultLocation',
    'DISPID_SRRTOffsetFromStart', 'SPSSuppressWord',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', '__MIDL_IWinTypes_0009',
    'DISPID_SRCERecognizerStateChange', 'eLEXTYPE_PRIVATE18',
    'SPRS_INACTIVE', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechPhraseReplacement', 'SVSFIsXML',
    'SAFTExtendedAudioFormat', 'SP_VISEME_1', 'SP_VISEME_16',
    'SPCT_SUB_DICTATION', 'DISPID_SRCESoundEnd', 'SVP_17',
    'SAFT48kHz16BitMono', 'ISpeechPhraseAlternate',
    'DISPID_SDKDeleteValue', 'SP_VISEME_11', 'DISPID_SVSVisemeId',
    'DISPID_SRCreateRecoContext', 'ISpeechLexiconPronunciations',
    'SpeechCategoryVoices', 'SDTRule', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPIReplacements', 'DISPID_SRRAudio',
    'DISPID_SDKGetBinaryValue', 'ISpeechAudioStatus',
    'SAFTGSM610_8kHzMono', 'SPSTREAMFORMATTYPE', 'SPEI_WORD_BOUNDARY',
    'ISpAudio', 'DISPID_SPIEngineId', 'SPWT_DISPLAY',
    'ISpeechPhraseElement', 'DISPID_SBSSeek', 'SVP_2',
    'DISPID_SPIGrammarId', 'DISPID_SOTId', 'eLEXTYPE_PRIVATE10',
    'DISPID_SABIBufferSize', 'DISPID_SOTIsUISupported',
    'ISpProperties', 'DISPID_SPRText', 'SPSERIALIZEDPHRASE',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechLexiconWord', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SPPParent', 'DISPID_SRCEEndStream',
    'ISpeechGrammarRuleStateTransitions', 'SBONone', 'SITooLoud',
    'SpeechCategoryAppLexicons', 'SVEAudioLevel',
    'SAFT32kHz16BitStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SpeechDictationTopicSpelling', 'SpFileStream',
    'DISPID_SpeechAudioStatus', 'DISPID_SVVolume', 'SRADynamic',
    'SP_VISEME_15', 'SRTReSent', 'SPBO_TIME_UNITS', 'SVP_9',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGetPropertyNumber', 'DISPIDSPRG',
    'SAFTCCITT_uLaw_22kHzStereo', 'SINone', 'SpeechDisplayAttributes',
    'DISPID_SpeechObjectTokens', 'SPSERIALIZEDRESULT',
    'ISpeechRecoResult', 'DISPID_SpeechXMLRecoResult',
    'SpeechTokenIdUserLexicon', 'SECHighConfidence', 'SPSMF_UPS',
    'DISPID_SRRSetTextFeedback', 'SPAO_NONE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechCustomStream',
    'DISPID_SVEEnginePrivate', 'SLTUser', 'SDTDisplayText',
    'DISPID_SRGId', 'SPAS_STOP', 'SpResourceManager',
    ...
    'SAFT8kHz8BitStereo', 'SPWORDTYPE', 'ISpEventSource',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPRuleFirstElement',
    'DISPID_SPEs_NewEnum', 'DISPID_SVGetVoices',
    'SpeechRecognitionType', 'SPCT_SLEEP',
    'DISPIDSPTSI_SelectionLength', 'SVP_21', 'eLEXTYPE_RESERVED9',
    'SPEI_UNDEFINED', 'SpeechLoadOption', 'SpLexicon',
    'SPVOICESTATUS', 'SVP_0', 'SRERecognition', 'STSF_LocalAppData',
    'SPINTERFERENCE', 'DISPID_SLWWord', 'SP_VISEME_19',
    '_RemotableHandle', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SBSFormat', 'DISPID_SGRSTText', 'SRERequestUI',
    'DISPID_SRCSetAdaptationData', 'SPAUDIOSTATE', 'DISPID_SRCPause',
    'SVP_1', 'DISPID_SRRTTickCount', 'DISPID_SWFEExtraData',
    'SPXMLRESULTOPTIONS', 'ISpeechAudio',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechAudioFormatGUIDText', 'SPEI_RESERVED6',
    'DISPID_SVDisplayUI', 'SpStreamFormatConverter', 'SVSFDefault',
    'SPEI_ADAPTATION', 'SVSFlagsAsync', 'eLEXTYPE_RESERVED6',
    'ISpPhoneConverter', 'DISPID_SABufferInfo', 'SpeechVoiceEvents',
    'SDTAlternates', 'DISPID_SRGDictationLoad',
    'SVSFPurgeBeforeSpeak', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPDKL_LocalMachine',
    'SLTApp', 'tagSPTEXTSELECTIONINFO', 'SRESoundStart',
    'DISPID_SPAStartElementInResult',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRs_NewEnum', 'SPPS_RESERVED3', 'SPRECOGNIZERSTATUS',
    'DISPID_SRCEAudioLevel', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGDictationUnload', 'SAFT16kHz8BitMono',
    'ISpPhoneticAlphabetConverter', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT11kHz16BitStereo', 'SPSHT_OTHER',
    'DISPID_SLAddPronunciation', 'SP_VISEME_0', 'DISPID_SLPLangId',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechRecoContext',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCEEnginePrivate',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLRemovePronunciation',
    'SFTInput', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SpeechPhraseElements', 'SAFTTrueSpeech_8kHz1BitMono',
    'SP_VISEME_10', 'ISpeechXMLRecoResult', 'SSSPTRelativeToEnd',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRCEPhraseStart', 'SPEI_MIN_SR',
    'SpVoice', 'ISpeechObjectTokens', 'ISpeechRecoGrammar',
    'SpeechSpecialTransitionType', 'DISPID_SRGCmdLoadFromMemory',
    'SPBO_PAUSE', 'SVSFNLPSpeakPunc', 'ISpeechPhraseRules',
    'ISpeechPhraseProperty', 'SP_VISEME_3', 'ISpeechBaseStream',
    'SPLO_DYNAMIC', 'DISPID_SPIRule', 'SPPHRASERULE',
    'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE1', 'SpMMAudioEnum',
    'ISpeechPhraseRule', 'SPSEMANTICERRORINFO', 'SpeechTokenKeyFiles',
    'SGRSTTDictation', 'SVP_19', 'DISPID_SpeechLexiconWords',
    'DISPID_SRCESoundStart', 'DISPID_SpeechGrammarRules',
    'DISPID_SGRsCommit', 'ISpeechRecoResultTimes',
    'DISPID_SPPs_NewEnum', 'SAFT12kHz8BitMono', 'SpSharedRecoContext',
    'DISPID_SGRSTWeight', '_ISpeechVoiceEvents', 'SVF_None',
    'SDKLLocalMachine', 'SpeechVisemeFeature', 'SVEAllEvents',
    'SpeechRetainedAudioOptions', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCVoicePurgeEvent', 'SWTAdded', 'DISPID_SGRAddState',
    'SRTSMLTimeout', 'DISPID_SpeechFileStream',
    'SRSInactiveWithPurge', 'SSSPTRelativeToCurrentPosition',
    'SASPause', 'SAFTCCITT_uLaw_22kHzMono', 'SECFIgnoreCase',
    'SPAR_High', 'ISpStreamFormatConverter', 'SPBO_NONE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPEAudioSizeTime',
    'WAVEFORMATEX', 'SITooSlow', 'ISpeechObjectTokenCategory',
    'SGSExclusive', 'DISPID_SOTCreateInstance',
    'DISPID_SRCEHypothesis', 'SpeechCategoryRecoProfiles',
    'DISPID_SGRSTNextState', 'SPPS_RESERVED2',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE11',
    'SpeechEngineProperties', 'SpMemoryStream', 'eLEXTYPE_PRIVATE15',
    'UINT_PTR', 'SPSNoun', 'DISPID_SPRuleId', 'SpeechInterference',
    'DISPID_SRCEInterference', 'DISPID_SRCCreateGrammar',
    'SPEI_END_SR_STREAM', 'eLEXTYPE_PRIVATE6', 'DISPID_SOTRemove',
    'SVEPhoneme', 'SPEI_RECOGNITION', '_SPAUDIOSTATE', 'SSFMCreate',
    'SPWT_LEXICAL', 'SPDKL_CurrentUser', 'SPSMF_SAPI_PROPERTIES',
    'SVSFIsNotXML', 'SPCATEGORYTYPE', 'DISPID_SLGetPronunciations',
    'DISPID_SRCRetainedAudio', 'eLEXTYPE_PRIVATE20', 'SP_VISEME_4',
    'DISPID_SPANumberOfElementsInResult', 'SPSModifier',
    'SpeechDataKeyLocation', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPFILEMODE', 'DISPID_SDKOpenKey', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SDKEnumKeys', 'DISPID_SVWaitUntilDone', 'DISPID_SRCVoice',
    'DISPID_SRCERequestUI', 'DISPID_SPPEngineConfidence',
    'DISPID_SVSpeak', 'ISpeechPhraseReplacement',
    'DISPID_SVSCurrentStreamNumber', 'SVSFParseSapi',
    'DISPIDSPTSI_SelectionOffset', 'SVEPrivate', 'DISPID_SASetState',
    'SVP_8', 'DISPID_SpeechAudio', 'SVPNormal', 'ISpMMSysAudio',
    'DISPID_SpeechVoiceEvent', 'SRARoot',
    'SpTextSelectionInformation', 'ISpeechCustomStream',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_RESERVED10',
    'SpeechPropertyAdaptationOn', 'DISPID_SPPsCount', 'SPCS_ENABLED',
    'SDA_Two_Trailing_Spaces', 'SPRECORESULTTIMES',
    'SPFM_CREATE_ALWAYS', 'SpNullPhoneConverter', 'DISPID_SGRSTType',
    'DISPID_SPCPhoneToId', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_RESERVED8', 'DISPID_SPRsItem', 'SpeechRuleAttributes',
    'DISPID_SVSLastResult', 'DISPID_SRRGetXMLResult',
    'SPDKL_CurrentConfig', 'SpeechTokenValueCLSID', 'DISPID_SLPsItem',
    'SVEVoiceChange', 'SpAudioFormat', 'SpeechWordPronounceable',
    'SAFTNoAssignedFormat', 'Speech_StreamPos_Asap',
    'ISpObjectTokenCategory', 'SRSInactive', 'DISPID_SGRAddResource',
    'SSFMCreateForWrite', 'ISpeechMemoryStream', 'eLEXTYPE_USER',
    'DISPID_SVSpeakStream', 'SpMMAudioOut', 'DISPID_SVEventInterests',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPAUDIOOPTIONS', 'SPCS_DISABLED',
    'SSTTTextBuffer', 'DISPID_SRAudioInputStream',
    'SAFT24kHz8BitMono', 'SGLexical', 'ISpRecognizer2',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVEStreamEnd',
    'SPEVENT', 'DISPID_SRGCmdSetRuleState',
    ...
    'ISpXMLRecoResult', 'DISPID_SASCurrentDevicePosition',
    'SAFT16kHz8BitStereo', 'DISPID_SGRSAddSpecialTransition',
    'SPEI_MAX_SR', 'SPFM_CREATE', 'ISpRecognizer', 'SINoise',
    'DISPID_SGRSTPropertyName', 'SAFT8kHz8BitMono',
    'DISPID_SRCEStartStream', 'DISPID_SpeechRecoResult2',
    'SpeechEmulationCompareFlags', 'SLODynamic',
    'DISPID_SRSetPropertyString', 'DISPID_SRIsUISupported',
    '_ISpeechRecoContextEvents', 'DISPID_SVEBookmark',
    'IEnumSpObjectTokens', 'DISPID_SGRSRule', 'SRTStandard',
    'DISPID_SRGIsPronounceable', 'ISpeechVoice',
    'DISPID_SOTCGetDataKey', 'DISPID_SPACommit',
    'SpeechBookmarkOptions', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPRFirstElement', 'SpeechRuleState',
    'DISPID_SGRAttributes', 'SRATopLevel',
    'DISPID_SpeechPhoneConverter', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRSSupportedLanguages',
    'ISpeechLexiconWord', 'SPEI_SOUND_START', 'eLEXTYPE_PRIVATE19',
    'SAFT12kHz8BitStereo', 'SPWT_PRONUNCIATION',
    'ISpeechPhraseProperties', 'SpeechPartOfSpeech',
    'SAFT16kHz16BitStereo', 'DISPID_SRAudioInput',
    'DISPID_SRGetFormat', 'SVP_10', 'SGDSInactive', 'SPEI_MAX_TTS',
    'SPFM_OPEN_READONLY', 'DISPID_SVGetAudioInputs',
    'ISpPhoneticAlphabetSelection', 'eLEXTYPE_APP',
    'SpeechEngineConfidence', 'DISPID_SPRules_NewEnum',
    'DISPID_SPEEngineConfidence', 'ISpLexicon', 'SVSFParseAutodetect',
    'DISPID_SVPause', 'SRSEIsSpeaking', 'DISPID_SVPriority',
    'DISPID_SWFEBitsPerSample', 'SPEI_START_INPUT_STREAM',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCResume', 'SVP_14',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechMMSysAudio', 'SPXRO_SML',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPPName', 'SP_VISEME_6',
    'SPWF_INPUT', 'DISPID_SRCState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpResourceManager', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPPNumberOfElements',
    'SPSNotOverriden', 'SVF_Emphasis', 'DISPID_SASFreeBufferSpace',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPIAudioSizeTime',
    'SWPUnknownWordPronounceable', 'SPCT_COMMAND', 'SVP_3',
    'DISPID_SRCRequestedUIType', 'SAFT48kHz8BitStereo',
    'ISpeechLexicon', 'DISPID_SPRuleEngineConfidence',
    'SAFT24kHz16BitStereo', 'SRERecoOtherContext',
    'SAFT12kHz16BitMono', 'SASStop', 'SRAExport', 'DISPID_SPRuleName',
    'DISPID_SVSLastStreamNumberQueued',
    'SWPUnknownWordUnpronounceable', 'SAFTCCITT_ALaw_44kHzStereo',
    'SVEBookmark', 'SPSFunction', 'SpeechVoiceSkipTypeSentence',
    'SGLexicalNoSpecialChars', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SWFEFormatTag', 'DISPID_SpeechVoice', 'DISPID_SRRTimes',
    'DISPID_SpeechGrammarRule', 'DISPID_SRRDiscardResultInfo',
    'ISpeechAudioBufferInfo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPWORD',
    'SpeechTokenShellFolder', 'DISPID_SVEAudioLevel', 'SWTDeleted',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechGrammarRuleState',
    'SP_VISEME_5', 'DISPID_SDKDeleteKey', 'ISpRecoGrammar2',
    'SREFalseRecognition', 'SVP_20', 'DISPID_SpeechRecoResult',
    'ISpeechLexiconWords', 'SpeechVoicePriority',
    'DISPID_SRCCmdMaxAlternates', 'SAFTGSM610_11kHzMono',
    'DISPID_SRRTLength', 'DISPID_SAFGetWaveFormatEx',
    'STCInprocHandler', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SRCERecognition', 'DISPID_SVGetAudioOutputs',
    'SSFMOpenForRead', 'SAFT48kHz16BitStereo', 'DISPID_SGRSTRule',
    'eWORDTYPE_DELETED', 'eLEXTYPE_PRIVATE3', 'DISPID_SPIStartTime',
    'DISPID_SFSOpen', 'SPEVENTSOURCEINFO', 'DISPID_SPAsCount',
    'SpeechMicTraining', 'SpPhoneConverter', 'ISequentialStream',
    'ISpeechWaveFormatEx', 'SpeechPropertyHighConfidenceThreshold',
    'eLEXTYPE_VENDORLEXICON', 'SpeechCategoryRecognizers',
    'SpObjectToken', 'SP_VISEME_13', 'SpeechRecoEvents',
    'SPEI_FALSE_RECOGNITION', 'SRCS_Enabled',
    'DISPID_SVESentenceBoundary', 'SVP_6', 'SECLowConfidence',
    'ISpeechPhraseInfoBuilder', 'SpeechAddRemoveWord',
    'SGRSTTEpsilon', 'DISPID_SpeechPhraseRules', 'SPVPRI_ALERT',
    'DISPID_SpeechAudioBufferInfo', 'SPPS_LMA',
    'DISPID_SVSInputSentenceLength', 'SPEI_MIN_TTS',
    'DISPID_SBSWrite', 'SASClosed', 'SpeechLexiconType',
    'SDTProperty', 'SREInterference', 'DISPID_SLPPartOfSpeech',
    'SPRST_ACTIVE_ALWAYS', 'SAFT12kHz16BitStereo',
    'DISPID_SLPPhoneIds', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SREmulateRecognition', 'SVP_18', 'SRAORetainAudio',
    'ISpeechPhraseElements', 'SVEEndInputStream',
    'DISPID_SpeechLexicon', 'DISPID_SRStatus', 'SPGRAMMARWORDTYPE',
    'SAFTGSM610_44kHzMono', 'DISPID_SPISaveToMemory',
    'SpeechAudioFormatGUIDWave', 'SDA_No_Trailing_Space',
    'DISPID_SpeechPhraseProperty', 'eLEXTYPE_PRIVATE2',
    'ISpRecoCategory', 'DISPID_SGRSTsCount',
    'DISPID_SPERequiredConfidence', 'SAFT44kHz8BitMono',
    'SP_VISEME_7', 'SSSPTRelativeToStart', 'DISPID_SPRulesCount',
    'DISPID_SPAsItem', 'SPPS_Noncontent', 'SpeechCategoryAudioOut',
    'SREStreamEnd', 'SPAUDIOBUFFERINFO', 'DISPID_SAStatus', 'SVP_15',
    'SGRSTTRule', 'DISPID_SpeechRecognizerStatus', 'DISPID_SVRate',
    'SpeechGrammarWordType', 'SPRECOCONTEXTSTATUS',
    'DISPID_SCSBaseStream', 'SPSHT_NotOverriden', 'ISpeechRecognizer',
    'SP_VISEME_2', 'IEnumString', 'SPBINARYGRAMMAR',
    'DISPID_SGRSTsItem', 'SRESoundEnd',
    'DISPID_SRSNumberOfActiveRules', 'SVP_7',
    'DISPID_SpeechPhraseInfo', 'STCInprocServer',
    'DISPID_SPEDisplayAttributes', 'SpeechRecoProfileProperties',
    'DISPID_SRGReset', 'SpStream', 'DISPID_SASNonBlockingIO',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SDKGetlongValue',
    'DISPID_SBSRead', 'DISPID_SLPsCount', 'IInternetSecurityManager',
    'SpCustomStream', 'SpeechVoiceSpeakFlags', 'DISPID_SOTDisplayUI',
    'SRTEmulated', 'SAFTGSM610_22kHzMono', 'SPLEXICONTYPE',
    'SITooFast', 'DISPID_SVSInputWordPosition', 'SREAdaptation',
    'DISPID_SPEDisplayText', 'SAFTNonStandardFormat',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRSAudioStatus',
    'SPEI_VOICE_CHANGE', 'SpeechAudioState', 'ISpRecoGrammar',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRGetRecognizers',
    'DISPID_SPPsItem', 'SPPHRASEPROPERTY', 'SPEVENTENUM',
    'SECFEmulateResult', 'SPRULE', 'SVF_Stressed',
    'SAFT11kHz16BitMono', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVSPhonemeId', 'DISPID_SVStatus', 'DISPID_SGRsDynamic',
    'STCLocalServer', 'SPFM_OPEN_READWRITE', 'SGDSActive',
    'SRSActiveAlways', 'eLEXTYPE_RESERVED4',
    'DISPID_SGRSTPropertyValue', 'DISPIDSPTSI',
    'DISPID_SPEAudioTimeOffset', 'SRCS_Disabled',
    ...
    'DISPID_SADefaultFormat', 'DISPID_SMSGetData', 'SpeechWordType',
    'SREStreamStart', 'DISPID_SPRuleConfidence',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPVPRI_OVER', 'SAFTText',
    'SRAONone', 'SSTTWildcard', 'SGPronounciation',
    'eLEXTYPE_USER_SHORTCUT', 'SPFM_NUM_MODES', 'STSF_FlagCreate',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPIAudioSizeBytes', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechTokenKeyUI', 'SVEStartInputStream', 'tagSTATSTG',
    'SPINTERFERENCE_TOOSLOW', 'SPRS_ACTIVE', 'SPEI_SENTENCE_BOUNDARY',
    'SVEViseme', 'SPEI_PHRASE_START', 'SpShortcut',
    'SPAO_RETAIN_AUDIO', 'SpeechStreamFileMode',
    'DISPID_SPRuleParent', 'SREBookmark', 'DISPID_SRRSpeakAudio',
    'DISPID_SRCRecognizer', 'SPSUnknown', 'SDA_One_Trailing_Space',
    'DISPID_SOTCId', 'SVSFPersistXML', 'DISPID_SOTCategory',
    'ISpeechDataKey', 'SPPS_Noun', 'DISPID_SAFType',
    ...
    'eLEXTYPE_PRIVATE9', 'SVP_11', 'DISPID_SPEPronunciation',
    'DISPID_SDKSetBinaryValue', 'ISpStreamFormat', 'ISpStream',
    'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_18', 'DISPID_SPPValue',
    'SAFT22kHz16BitMono', 'ISpeechAudioFormat',
    'ISpeechResourceLoader', 'DISPID_SOTsItem', 'DISPID_SGRs_NewEnum',
    'DISPID_SVEWord', 'SpeechGrammarTagDictation', 'DISPID_SAFGuid',
    'DISPID_SGRSTransitions', 'SAFTADPCM_44kHzMono',
    'DISPID_SRGState', 'ISpNotifyTranslator',
    'DISPID_SDKSetLongValue', 'eLEXTYPE_PRIVATE5',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRRAlternates',
    'DISPID_SVAlertBoundary', 'SP_VISEME_8',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SFSClose',
    'ISpObjectWithToken', 'DISPID_SOTs_NewEnum', 'ISpeechRecoContext',
    'DISPID_SpeechPhraseRule',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SLOStatic',
    'SGRSTTWildcard', 'SAFT32kHz8BitMono', 'SREPropertyNumChange',
    'SPGS_EXCLUSIVE', 'ISpRecoResult', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVAudioOutput', 'SVP_4', 'DISPID_SGRsItem',
    'SVSFIsFilename', 'DISPID_SGRsCount', 'DISPID_SLPType',
    'DISPID_SGRsAdd', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_uLaw_44kHzMono', 'SPGS_ENABLED', 'SpInProcRecoContext',
    'IStream', 'DISPID_SLWsCount', 'DISPID_SLWsItem',
    'DISPID_SMSSetData', 'SREPhraseStart', 'SITooQuiet',
    'DISPID_SPRNumberOfElements', 'SPBOOKMARKOPTIONS',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVSFVoiceMask',
    'eLEXTYPE_PRIVATE14', 'STSF_CommonAppData',
    'SpeechRecoContextState', 'ISpeechObjectToken',
    'SpeechGrammarTagWildcard', 'SpeechRecognizerState',
    'SPPS_SuppressWord', 'DISPID_SPARecoResult', 'DISPID_SLWLangId',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE17',
    'SpObjectTokenCategory', 'STCRemoteServer', 'SPSHORTCUTTYPE',
    'SPEI_SOUND_END', 'SPTEXTSELECTIONINFO', 'DISPID_SVEViseme',
    'SGRSTTWord', 'ISpeechRecoResult2', 'DISPID_SWFEChannels',
    'SFTSREngine', 'SRTExtendableParse', 'SpeechAudioProperties',
    'SAFT44kHz16BitMono', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRSTs_NewEnum',
    'SpSharedRecognizer', 'SP_VISEME_9', 'SP_VISEME_17',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRSEDone',
    'SREPropertyStringChange', 'ISpeechTextSelectionInformation',
    'SVP_13', 'DISPID_SAEventHandle', 'SAFT8kHz16BitMono',
    'SpPhraseInfoBuilder', 'SGDisplay', 'SPAS_CLOSED', 'SPAS_PAUSE',
    'SPRULESTATE', 'DISPID_SRGCmdLoadFromFile', 'DISPID_SVEPhoneme',
    'DISPID_SRCEBookmark', 'SPSVerb', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPIElements', 'SPSHORTCUTPAIR', 'SVP_5',
    'DISPID_SRSClsidEngine', 'ISpSerializeState', 'SPEI_VISEME',
    'SpeechAudioVolume', 'DISPID_SLPSymbolic',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRRSaveToMemory',
    'SPWORDPRONUNCIATION', 'ISpGrammarBuilder', 'DISPID_SDKCreateKey',
    'DISPID_SRRGetXMLErrorInfo', 'ISpEventSink', 'ISpRecognizer3',
    'DISPID_SRIsShared', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SPPFirstElement', 'ISpeechGrammarRuleState',
    'DISPID_SpeechVoiceStatus', 'SpeechVisemeType', 'SPPHRASEELEMENT',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPChildren',
    'SRAImport', 'SPEI_RESERVED1', 'SGRSTTTextBuffer',
    'Speech_Max_Word_Length', 'SPRST_INACTIVE',
    'DISPID_SpeechAudioFormat', 'SPWORDLIST', 'SP_VISEME_21',
    'DISPID_SABufferNotifySize', 'ISpeechFileStream',
    'SAFTADPCM_11kHzMono', 'SPRST_ACTIVE', 'ISpeechPhraseAlternates',
    'DISPID_SASState', 'SSTTDictation', 'DISPID_SDKSetStringValue',
    'DISPID_SRCRetainedAudioFormat', 'SPCT_SUB_COMMAND',
    'DISPID_SRGDictationSetState', 'SPEI_SR_PRIVATE',
    'SPPHRASEREPLACEMENT', 'SPDKL_DefaultLocation',
    'DISPID_SGRInitialState'
]

_check_version('1.2.0', 1630398635.568098)
